...
public class VariablesTheme {
    public static void main(String[] args) {
        ...
        float discountSum = basePrice * discountPercent / 100;
        ...
        var discountSumBd = basePriceBd
                .multiply(discountPercentBd)
                .divide(BigDecimal.valueOf(100))
                .setScale(2, RoundingMode.HALF_UP);

        var discountPriceBd = basePriceBd
                .subtract(discountSumBd)
                .setScale(2, RoundingMode.HALF_UP);
        ...
        double totalMemory = rt.totalMemory() / mb;
